...
export const GENERIC_ERROR = 'صار خطأ — جرّب مرة ثانية';
export const copyFor = (code?: string) => (code && ERROR_COPY[code]) || GENERIC_ERROR;
  ...
  return (
    <div className="fixed inset-0 z-[60] flex md:items-center md:justify-center" dir="rtl">
      ...
      <BookingCancelPanel
        ...
        setCancelStage={setCancelStage}
        upcoming={upcoming}
        setUpcoming={setUpcoming}
        loadingUpcoming={loadingUpcoming}
        setLoadingUpcoming={setLoadingUpcoming}
        cancelError={cancelError}
        setCancelError={setCancelError}
        reasonOption={reasonOption}
        reasonText={reasonText}
        selectReasonOption={selectReasonOption}
