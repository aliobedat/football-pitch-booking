...
export default function PitchDetailPage() {
  ...
  useEffect(() => {
    api.get(`/pitches/${id}`)
      ...
      .catch(() => {
        setError('تعذّر تحميل بيانات الملعب');
      })
      .finally(() => {
        setIsLoading(false);
      });
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#0d0f0e]">
      ...
      <div className="relative w-full h-64 sm:h-80 overflow-hidden">
        ...
        {/* Bottom gradient — fades the diagram into the page bg */}
      ...
      <main className="max-w-7xl mx-auto px-6 pt-8 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="flex flex-col gap-1.5 p-4 rounded-xl bg-[#141715] border border-white/[0.07]">
                ...
                <span className="text-[10px] text-white/30">{pitch.reviewCount} تقييم</span>
              </div>
            ...
            {pitch.amenities.length > 0 && (
              <div className="p-5 rounded-xl bg-[#141715] border border-white/[0.07]">
                <h2 className="text-[13px] font-bold text-[#f0efe8] mb-3.5">
                  المرافق والخدمات
                </h2>
          ...
          {/* ── Booking form column (1 / 3) — sticky on desktop ── */}
